...
- [x] T001 [P] [US1] Refactor `PracticeScreen` to use EventBus in `src/ui/screens/practice-screens/PracticeScreen.astro`
- [x] T002 [P] [US1] Refactor `FlashcardScreen` to use EventBus in `src/ui/screens/practice-screens/FlashcardScreen.astro`
- [x] T003 [P] [US1] Refactor `HardcoreScreen` to use EventBus in `src/ui/screens/challenge-screens/HardcoreScreen.astro`
- [x] T004 [P] [US1] Refactor `ExamScreen` to use EventBus in `src/ui/screens/challenge-screens/ExamScreen.astro`
- [x] T005 [P] [US1] Refactor `BlitzScreen` to use EventBus in `src/ui/screens/challenge-screens/BlitzScreen.astro`
...
- [x] T006 [US2] Refactor mode launchers to emit `game:start` events in `src/ui/screens/HomeScreen.astro`
- [x] T007 [US2] Update `AchievementsScreen` to use EventBus navigation in `src/ui/screens/AchievementsScreen.astro`
- [x] T008 [US2] Update `BackButton` component to use EventBus navigation in `src/ui/components/BackButton.astro`
